...
namespace _10_Interfaces.Fruits
{
    ...
    {
        // I don't have to define all those methods and properties again, it uses the Madarin definitions.
        // Here, I can add properties that Mandarin will have but not orange
